...
const dummy_data_2 = [
    ...
    function renderItem({item, index}) {
        const final_url = urlCreator(item?.cover_id, 'medium');
        ...
        return (
            <Pressable 
                ...
                onPress={()=>{}}
            >
                <View style={{elevation: 24, shadowColor: 'black', borderRadius: ms(20)}}>
                <Image
                ...
                <Text style={styles.item.titleText}>{titleName}</Text>
